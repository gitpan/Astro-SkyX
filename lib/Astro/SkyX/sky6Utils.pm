...
our $VERSION = '0.03';
our @PROPERTIES = qw( ConvertStringToRA ConvertStringToDec ConvertEquatorialToString ConvertHorizonToString ConvertRADecToAzAlt ConvertAzAltToRADec ConvertJulianDateToCalendar ConvertCalendarToJulianDate ConvertDMSToAngle ConvertAngleToDMS ConvertSexagesimalToString ComputePositionAngle ComputeAngularSeparation ComputeHourAngle ComputeAirMass ComputeLocalSiderealTime ComputeUniversalTime ComputeJulianDate ComputeRefraction ComputeRiseTransitSetTimes PrecessNowTo2000 Precess2000ToNow );
our @READWRITEPROPS = qw( strOut );
