...
our $VERSION = '0.03';
our @PROPERTIES = qw( Abort CloseSlit Connect Disconnect FindHome GetAzEl GotoAzEl OpenSlit Park Sync Unpark );
our @READWRITEPROPS = qw( IsCoupled );
