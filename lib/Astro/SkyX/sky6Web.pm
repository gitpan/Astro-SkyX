...
our $VERSION = '0.03';
our @PROPERTIES = qw( CreateStarChart MapCmdTextToTSWC SlewToObject Sleep GetThisDayJDAt AbortSlew );
our @READWRITEPROPS = qw( ChartFileName CurAlt CurAz CurDec CurFOV CurRa CurRotation LASTCOMERROR Test );
