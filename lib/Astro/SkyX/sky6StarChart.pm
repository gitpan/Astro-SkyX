package Astro::SkyX::sky6StarChart;
...
our $VERSION = '0.03';
our @PROPERTIES = qw( ClickFind EquatorialToStarChartXY Find Open Refresh Save StarChartXYToEquatorial UpdateSolarSystem DocumentProperty SetDocumentProperty DisplayProperty SetDisplayProperty Declination FieldOfView HeightInPixels Path RightAscension Rotation WidthInPixels );
our @READWRITEPROPS = qw( Declination FieldOfView HeightInPixels Path RightAscension Rotation WidthInPixels );
