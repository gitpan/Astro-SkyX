package Astro::SkyX::sky6RASCOMTheSky;
...
our $VERSION = '0.03';
our @PROPERTIES = qw( Abort AutoMap Connect ConnectDome CoupleDome Disconnect DisconnectDome DisconnectTelescope GetObjectAzAlt GetObjectRaDec GetObjectRaDec2000 ImageLink SetTelescopeParkPosition Quit SetWhenWhere );
our @READWRITEPROPS = qw( dObjectAlt dObjectAz dObjectDec dObjectRa dScreenDec dScreenFOV dScreenRa dScreenRotation IsAsynchronous );
