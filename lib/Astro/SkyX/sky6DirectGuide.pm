package Astro::SkyX::sky6DirectGuide;
...
our $VERSION = '0.03';
our @PROPERTIES = qw( Abort MoveTelescope );
our @READWRITEPROPS = qw( lAsynchronous lSpeedIndex );
...
Robert Woodard, E<lt>kayak.man.comE<gt>
